...
import java.io.*;
	public class Graph_M 
	{
		...
		public static void Create_Metro_Map(Graph_M g)
		{
			...
			g.addEdge("Janak Puri West", "Dwarka Sector", 6);
			...
			g.addEdge("DDS Campus", "IGI Airport", 8);
			g.addEdge("Moti Nagar", "Rajouri Garden", 2);
			g.addEdge("Punjabi Bagh West", "Rajouri Garden", 2);
			g.addEdge("Punjabi Bagh West", "Netaji Subhash Place1", 3);
		}	
